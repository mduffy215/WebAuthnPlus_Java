...
/*
 * This action is called from the WebAuthn+ mobile app for the update Firebase device ID process.  All 
 ...
 */
public class UpdateFirebaseDeviceIdAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {

  private static final long serialVersionUID = 761965526198965314L;

  private static Logger logger = LogManager.getLogger(UpdateFirebaseDeviceIdAction.class);
