 ...
 * 
 * Order of precedence within io.trustnexus.struts.actions.signon:  66
 */
public class SignOnSessionTimeoutAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {

  private static final long serialVersionUID = 3399403768087170809L;

	private static Logger logger = LogManager.getLogger(SignOnSessionTimeoutAction.class);  
  ...
  public String execute() {
    ...
    if (user != null) {
      ...
      if (authentication != null && authentication.getVerificationCode() == null) {      
        authentication.setVerificationCode(Constants.SESSION_TIMEOUT);      
        AuthenticationDao.updateVerificationCode(authentication); 
      }
    }
