 ...
 */
public class RetrieveCredentialMetaDataAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {

  private static final long serialVersionUID = 1771432310692776205L;

  private static Logger logger = LogManager.getLogger(RetrieveCredentialMetaDataAction.class); 
