  ...
  public String execute() {
    ...
    try {
      ...
      if (user != null) {
        ...
        /*
         * TODO:  In a production level system there will be some check to see if the user is authorized to create this credential.
         */
	      ...
	      if (existingCredential == null) {
	         ...
	         * actor to hijack the credential creation process.
	         */
