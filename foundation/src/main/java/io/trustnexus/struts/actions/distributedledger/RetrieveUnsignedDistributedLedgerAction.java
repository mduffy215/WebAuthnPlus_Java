 ...
 * 
 * Order of precedence within io.trustnexus.struts.actions.distributedledger:  44
 */
public class RetrieveUnsignedDistributedLedgerAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {

  private static final long serialVersionUID = 7497278454442037508L;

  private static Logger logger = LogManager.getLogger(RetrieveUnsignedDistributedLedgerAction.class);
          ...
          if (credential != null) {
            ...
            if (verifyTransactionUuidMessage.equals(PropertyManager.getInstance().getProperty(Constants.TRANSACTION_UUID_VERIFIED))) {
              ...
              if (verifySignatureMessage.trim().equals(PropertyManager.getInstance().getProperty(Constants.SIGNATURE_VERIFIED))) {
                ...
                responseString = Constants.DISTRIBUTED_LEDGER + "=" + distributedLedgerCheck.getJsonDistributedLedger() + "&";
