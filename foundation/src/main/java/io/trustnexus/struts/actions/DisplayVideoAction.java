...
public class DisplayVideoAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {

  private static final long serialVersionUID = 1646074465998580303L;

  private final static Logger logger = LogManager.getLogger(DisplayVideoAction.class);
  ...
  public String execute() {
    ...
    /*
     * This action displays the Video and registers the IP address of the visitor.  The web page which 
