...
public class Constants {
  ...
  // ------------------------------------------------------------------------------------------------------------------
	 ...
	 *   InitializeA_Types
   *   InitializeB_Keys
	 *   InitializeC_CredentialProvider
	 *   InitializeD_Types
	 *   
	 * Since these classes will most likely be run from within Eclipse in a secure administrative environment, it makes 
	 * sense to keep the following constants in code, rather than create a properties file that would be referenced from 
	 * a jar file.
   * 
   * Some of these same values which are used in the web application are also found in 
   * /resources/config.properties
	...
	/*
	 * If you create a test financial credential provider and a test financial credential type (".Financial"),
	 * set the credentialProviderUuid here,
	 * 
	 */
	 ...
	 *  Labels and messages that would be translated for internationalization.
	 */
  ...
  public static final String SEND_EMAIL_ADDRESS = "SEND_EMAIL_ADDRESS";
	...
	public static final char[] CHARACTER_ARRAY = { 'A', 'B', 'C', 'D', 'E', 'F',
			'G', 'H', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W',
			'X', 'Y', 'Z' };

	public static final String[] SENSITIVE_WORDS_FOUR = { "ABBO", "ALLA", "ANAL",
			"ANUS", "ARAB", "ARSE", "BANG", "BARF", "BAST", "BLOW", "BOMB", "BOMD",
			"BOOB", "BOOM", "BUNG", "BUTT", "CHAV", "CHIN", "CIGG", "CIGS", "CLIT",
			"COCK", "COHE", "COON", "CRAP", "CUMM", "CUNN", "CUNT", "DAGO", "DAMN",
			"DEAD", "DEGO", "DETH", "DIED", "DIES", "DIKE", "DINK", "DONG", "DOOM",
			"DOPE", "DRUG", "DUMB", "DYKE", "EVIL", "FAGG", "FART", "FEAR", "FIRE",
			"FLOO", "FORE", "FUCK", "FUKS", "GOOK", "GOYM", "GUNN", "GYPO", "GYPP",
			"HEBE", "HEEB", "HELL", "HOBO", "HOES", "HOLE", "HOMO", "HORE", "HORK",
			"ITCH", "JIGA", "JISM", "JIZM", "JIZZ", "JUGS", "KIKE", "KILL", "KINK",
			"KOON", "KRAP", "KUNT", "KYKE", "LEZZ", "LIES", "LIMY", "METH", "MILF",
			"MOFO", "MOKY", "MUFF", "MUNT", "NAZI", "NIGG", "NIGR", "NUDE", "NUKE",
			"ORAL", "ORGA", "ORGY", "PAKI", "PAYO", "PERV", "PHUK", "PHUQ", "PIMP",
			"PISS", "PIXY", "POHM", "POON", "POOP", "PORN", "PRIC", "PUBE", "PUDD",
			"PUKE", "PUSS", "PUSY", "QUIM", "RAPE", "RUMP", "SATN", "SCAG", "SCAT",
			"SCUM", "SEXX", "SEXY", "SHAG", "SHAT", "SHAV", "SHIT", "SICK", "SKUM",
			"SLAV", "SLUT", "SMUT", "SNOT", "SPIC", "SPIG", "SPIK", "SPIT", "SUCC",
			"SUCK", "TAFF", "TANG", "TARD", "TEAT", "TITT", "TITS", "TITY", "TURD",
			"TWAT", "VIBR", "WANK", "WHIT", "WHIZ", "WHOP", "WHOR", "WUSS", "XXXX" };

	public static final String[] SENSITIVE_WORDS_THREE = { "ALA", "CUM", "FAG",
			"FUC", "GOD", "JAP", "JIZ", "KIL", "LIE", "LDS", "LSD", "NIG", "PIS",
			"PEE", "PUD", "PUS", "SEX", "SAD", "SIC", "SUC", "SUX", "TIT", "WIZ",
			"XXX" };
	...
	/*
	 * Constants used in code, usually between the web application and the TNX Secure mobile app.
	 */
