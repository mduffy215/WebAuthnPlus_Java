...
public class VisitorThreatDao {

  private final static Logger logger = LogManager.getLogger(VisitorDao.class);

  public static final String INSERT 
                             = "INSERT VisitorThreat (created, updated, updatedById, dataSourceTypeValue, remoteAddress, remoteHost, refCode)"
                             + "VALUES (?, ?, ?, ?, ?, ?, ?)";

  // ------------------------------------------------------------------------------------------------------------------
  
  public VisitorThreatDao() {    
  }
