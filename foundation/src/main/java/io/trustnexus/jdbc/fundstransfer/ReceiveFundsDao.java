...
public class ReceiveFundsDao {

  private final static Logger logger = LogManager.getLogger(ReceiveFundsDao.class);

  public static final String INSERT = "INSERT ReceiveFunds (created, updated, updatedById, dataSourceTypeValue, "
  ...
  public static final String UPDATE_JSON 
                             = "UPDATE ReceiveFunds SET updated = ?, json = ? "  
                             + "WHERE fundsTransferUuid = ?";

  // ------------------------------------------------------------------------------------------------------------------

  public ReceiveFundsDao() {
  }
