...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <head>
    ...
    <title>JSON DLT Signature Request</title> <!-- dltSignatureRequest.jsp -->
    
    <script type="text/javascript" src="../../foundation/javascript/webAuthnPlus.js"></script>   
  </head>

  <body onload="initializeDistributedLedgerSignatureRequest();">
      ...
      <div class="row">
        ...
        <div class="col-deskTopB col-tabletB">
          <div class="mainText">
            ...
            <h2><span class="font_emphasis">JSON DLT Signature Request</span></h2>
            ...
            <div id="signature1">
	            ...
	            <div class="textDivC"><span class="font_emphasis">Authentication Code: &nbsp;</span> <span class="font_alert"><span id='authenticationCode'></span></span></div>
	            <div class="textDivB">Verify the <span class="font_emphasis">Authentication Code</span> then touch the <span class="font_emphasis">Signature</span> 
	                 button in your <span class="font_emphasis">TNX WebAuthn+</span> mobile app.</div>
	                 
	            <div id="signatureMessage" class="textDivC"></div>
	            
	          </div>
            
            <div id="signature2">
            
              <div class="textDivB"><strong><span id="thankyou"></span></strong></div>            
              <div class="textDivB">Signature Successful</div>            
              <div class="textDivA"><span class="font_emphasis">Verification Code: &nbsp;</span> <span class="font_alert"id="verificationCode"></span></div>              
            
              <div class="textDivA"><img src="../../foundation/images/pixel_brownze.png" height="2" width="100%"/></div>
              
              <div class="textDivA">
                A complex managerial / financial process will have multiple entries in the 
                <span class="font_emphasis">JSON Distributed Ledger</span>; each entry will be signed by a cryptographically secure digital credential.&nbsp; 
                Each signature will be "chained" into the distributed ledger creating an immutable business / legal document.
              </div>
            
              <div class="textDivA"><img src="../../foundation/images/pixel_brownze.png" height="2" width="100%"/></div>
              
              <div id="jsonDistributedLedgerId" class="font_computer"><s:property escapeHtml="false" value="htmlJsonDistributedLedger"/></div>
        ...
        <div class="col-deskTopA col-tabletC">
          <div class="rightPanel">
            <p>Cryptographically secure distributed ledgers will become a new archetype for business 
                processes and financial transactions creating the Internet of Value.</p>
          </div>
        </div>
      </div>
