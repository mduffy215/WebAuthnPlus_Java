...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <head>
    ...
    <title>WebAuthn+ Sign On</title> <!-- signOn.jsp -->
      ...
      <div class="row">
        <div class="col-deskTopA col-tabletA menu">
          <ul>
            ...
            <li class="selected" onclick="location.href='../../foundation/view/signOn.jsp?credentialType=com.webauthnplus.credentialtype.TNX_Test_1';">Sign On</li>
        ...
        <div class="col-deskTopB col-tabletB">
          <div class="mainText">
            ...
            <div id="distributedLedgerInitializedMessage" class="textDivC">
              </span> <span class="font_alert">You must first sign on before you can test JSON DLT.</span>
            </div>
                   
            <h2><span class="font_emphasis">Sign On ~ <span id="credentialDisplayNameSpan"></span></span></h2>
            ...
            <div id="authentication1" class="textDivA">
              ...
              <div class="textDivA">Open your <span class="font_emphasis">TNX WebAuthn+</span> mobile app; your mobile device will appear in the pairing screen.&nbsp;  
                <br></>Pair your device then touch the <span class="font_emphasis">Sign On</span> button in your <span class="font_emphasis">TNX WebAuthn+</span> mobile app.</div>
            ...
            <div id="authentication2">
              ...
              <div class="textDivA"><s:textfield key="email" size="30" onkeypress="if (event.keyCode == 13) {initializeButtonClick();}" spellcheck="false"/></div>
              ...
              <div class="textDivA"><a href="javascript: initializeButtonClick()"><img style="width: 100px; height: 28px; border: 0;" 
                                        src="../../foundation/images/button_webauthn+.png"></img></a></div> 
              <div class="textDivC">When you click the WebAuthn+ button a screen will be displayed to pair your smart phone to this web page through a 
            ...
            <div id="authentication3">
              ...
              <div class="textDivA"><input type="checkbox" id="deestablishTrustedSystem">&nbsp; <span class="font_emphasis">This system is no longer a trusted system.</span></div>
            
              <div class="textDivA">Please enter the <span class="font_alert">contact email address</span> for your <span class="font_emphasis">TNX WebAuthn+</span> mobile app.</div>              
              <div class="textDivA"><s:textfield key="email2" size="30" spellcheck="false"/></div>
              <div id="userNotFoundDisplay2" class="textDivA">The <span class="font_alert">contact email address</span> you entered was not found in our system.</div>
            
              <div class="textDivA">Please enter the <span class="font_alert">password</span> you created when you established this system as a <span class="font_emphasis">Trusted System</span>.</div>              
              <div class="textDivA"><s:password key="password" size="30" onkeypress="if (event.keyCode == 13) {sigOnButtonClick();}" spellcheck="false"/></div>
              <div id="signOnFailure" class="textDivA">The sign on process <span class="font_alert">failed</span>.</div>
              
              <div class="textDivA"><a href="javascript: sigOnButtonClick()"><img style="width: 100px; height: 28px; border: 0;" 
                                        src="../../foundation/images/button_webauthn+.png"></img></a></div>           
            </div>
        ...
        <div class="col-deskTopA col-tabletC">
          <div class="rightPanel">
            <p>This institutional validation represents a stamp of approval.&nbsp;  
              If the stamp is cryptographically valid, the authentication can be trusted.</p>
          </div>
        </div>
      </div>
